export default function Naboer() {
  return (
    <div style={{maxWidth:600}}>
      <h1 style={{fontSize:20,fontWeight:300,color:'#3d3530',marginBottom:24}}>Naboer</h1>
      <div style={{
        background:'white',borderRadius:16,boxShadow:'0 1px 4px rgba(0,0,0,.06)',
        border:'1px solid #f1ede8',padding:48,textAlign:'center',
      }}>
